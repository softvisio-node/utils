...
const ansiStyle = ansi =>
    class AnsiStyle {
        ...
        // public
        color ( color ) {
            return this.ansi.color( color, this );
        }

        onColor ( color ) {
            return this.ansi.onColor( color, this );
        }
...
export class Ansi {
    ...
    createStyle ( { on, off }, baseStyle ) {
        ...
        if ( baseStyle ) {
            on = baseStyle.on + on;
            off = off + baseStyle.off;
        }

        const instance = new this.#AnsiStyle( on, off );

        return makeCallable( instance, "applyStyle" );
    }
    ...
    defineStyle ( name, style ) {
        ...
        Object.defineProperty( this.#AnsiStyle.prototype, name, {
            "configurable": true,
            get () {
                return this.ansi.createStyle( style, this );
            },
        } );
    ...
    color ( color, baseStyle ) {
        return this.createStyle(
            {
                "on": this.#createColorCode( 38, color ),
    ...
    onColor ( color, baseStyle ) {
        return this.createStyle(
            {
                "on": this.#createColorCode( 48, color ),
